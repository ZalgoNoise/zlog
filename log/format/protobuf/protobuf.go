...
// Format method will take in a pointer to an Event; and returns a slice of bytes
// and an error.
//
// This method will process the input Event and marshal it according to this LogFormatter
