...
var LogFormatters = map[int]LogFormatter{
	...
	4:  &gob.FmtGob{},
	5:  &bson.FmtBSON{},
	6:  text.New().Time(text.LTRFC3339).Build(),
	7:  text.New().Time(text.LTRFC822Z).Build(),
	8:  text.New().Time(text.LTRubyDate).Build(),
	9:  text.New().DoubleSpace().Build(),
	10: text.New().DoubleSpace().LevelFirst().Build(),
	11: text.New().LevelFirst().Build(),
	12: text.New().DoubleSpace().Color().Build(),
	13: text.New().DoubleSpace().LevelFirst().Color().Build(),
	14: text.New().LevelFirst().Color().Build(),
	15: text.New().Color().Build(),
	16: text.New().NoHeaders().NoTimestamp().NoLevel().Build(),
	17: text.New().NoHeaders().Build(),
	18: text.New().NoTimestamp().Build(),
	19: text.New().NoTimestamp().Color().Build(),
	20: text.New().NoTimestamp().Color().Upper().Build(),
}
